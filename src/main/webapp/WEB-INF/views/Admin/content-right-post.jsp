	...
	<script type="text/javascript">
				...
				visiblePages: 7,
                         ...
                         function postupdown(index,updown1,type){
                            ...
                            $.ajax({
                           type: "get",
                           url: "<%=request.getContextPath()%>/admin/postupdown.htm",
                           cache: true,		
                           ...
                           success: function(response){
                             ...
                             for( i = 0; i< obj.length; i++){
                                 s += "<div class='divlist' id='" + i + "'>" 
                                    ...
                                    +             "<a href='<%=request.getContextPath()%>/admin/postedit.htm?Post_link="+ obj[i].Post_link+"' style = 'margin-left: 10px'><u>Edit</u></a>"
                                    +         "</h3>"
                        ...
                        function postdelete(post_link){
                            ...
                            $.ajax({
                           type: "get",
                           url: "<%=request.getContextPath()%>/admin/postdelete.htm",
                           cache: true,		
